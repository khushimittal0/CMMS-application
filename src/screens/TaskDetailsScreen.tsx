...
export function TaskDetailsScreen() {
  ...
  const handleStatusChange = (newStatus: TaskStatus) => {
    ...
    setTimeout(() => {
      ...
      setIsUpdating(false);
      Alert.alert('Status Updated', `Task status has been updated to "${newStatus}"`);
    }, 450);
  };
  ...
  const getStatusStyle = (status: TaskStatus) => {
    switch (status) {
      ...
      case 'In Progress':
        return { bg: '#E3F2FD', text: theme.colors.primary };
      case 'Pending':
      default:
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.detailsCard}>
          ...
          <View style={styles.detailRow}>
            <Text style={styles.fieldLabel}>Equipment ID</Text>
            <Text style={styles.fieldVal}>{task.equipmentId}</Text>
          </View>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={[styles.fieldVal, styles.bold]}>{task.priority}</Text>
          </View>
